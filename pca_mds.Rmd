...
title: "Principal Component Analysis and Multidimensional Scaling"
output:
  html_document:
    toc: true
    toc_float: true
...
```{r message=FALSE, warning=FALSE, fig.cap = 'Figure 1.1 The correlation matrix.'}
...
```{r message=FALSE, warning=FALSE, fig.cap = 'Figure 1.2 The correlation matrix.'}
...
```{r , fig.cap = 'Figure 1.3 Scree Plot - Morphometric Data.'}
...
```{r, fig.cap = 'Figure 1.4 Principal component analysis (PCA).'}
...
```{r, fig.cap = 'Figure 1.5 Principal component analysis (PCA) - groups.'}
...
```{r, fig.cap = 'Figure 2.1 Configuration of points representing cities.'}
